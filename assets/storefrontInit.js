(function() {
    ...
    const helper = {
        ...
        ccPages: function() {
            return {
                "product": document.querySelector('div[data-section-type="product"]'),
              	"reviews": document.querySelector("#looxReviews"),
              	"social": document.querySelector(".social-sharing"),
